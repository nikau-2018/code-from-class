...
function addUser(user) {
  return _superagent2.default.post('/api/v1/users').send(user).then(function (res) {
    console.log('success');
  }).catch(function (err) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Form2.default, { updateUserList: this.getUsers })
      );
    }
  }]);
...
var Form = function (_React$Component) {
  ...
  function Form(props) {
    ...
    _this.handleClick = function (e) {
      _api2.default.addUser(_this.state).then(_this.props.updateUserList);
    };
