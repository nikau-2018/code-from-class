...
function ShowDog(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      'p',
      null,
      label.length > 0 ? label : 'NO LABEL SPECIFIED'
    ),
    React.createElement('img', { src: dogUrl })
  );
}
...
function helloTemplate(props) {
  return React.createElement(
    ...
    React.createElement(ShowDog, { label: '', dogUrl: data.dogUrl }),
    React.createElement(ShowDate, null)
  );
}
